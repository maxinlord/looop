...
def welcome(message):
    bot.send_message(message.chat.id,'Здравствуйте вас приветствует бот для рассылки поста по чатам. Нажмите соответствующий пункт меню для создания новой рассылки',reply_markup=markup1 )
